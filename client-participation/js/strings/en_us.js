...
s.ideathonTitle = "Share your thoughts on generative AI";
s.ideathonDescription = `
<article>
            <p>
	        <span>Is AI generated content protected by law? Who owns the copyright?</span>
	    </p>
	    <p>
	        <span>Artificial intelligence brings profound social changes and issues such as intellectual property rights, technology ethics, and public services. They have also posed new challenges to democratic governance. In response to the social concerns arising from the wave of generative AI, the Ministry of Digital Affairs (MODA) is taking steps to invite Idea</span>
	        <span class="ui-comment-inline-span">tion participants, creato</span>
	        <span>rs, and experts to discuss AI ethics and the experiences in the creative process through the online platform Polis and deliberative workshops. It aims to provide important information to policymakers and technology developers, as well as the Ideathon submission rules, ensuring that the development of artificial intelligence aligns with the public interests.</span>
	    </p>
	    <p>
	        <span>The categories of topics we will discuss include, but are not limited to, the following. Feel free to add new seed comments:</span>
	    </p>
	    <ol>
	        <li>
	            <span>Fundamental understanding of AI (Is AI a tool, collaborator, or creator?)</span>
	        </li>
	        <li>
	            <span>AI in creative processes (Can AI tools inspire human creativity?)</span>
	        </li>
	        <li>
	            <span>Copyright and revenue-sharing mechanisms (Is content generated by AI protected by law? Who owns the copyright?)</span>
	        </li>
	        <li>
	            <span>Social and industry impact (What changes will AI bring to society and industry ecosystems? Should the government strengthen regulation?)</span>
	        </li>
	        <li>
	            <span>
	                Fair opportunity, <bvtag class="memorize_new_word bv_hackmd_io bv_browserName_google_chrome burning_vocabulary _id_1647494121106">bias</bvtag>
	                , and discrimination (How can we promote equal opportunities in AI usage? Is fair and just AI achievable?)
            </span>
	        </li>
	        <li>
	            <span>AI in Public Governance (How will AI affect government policy-making, organizational operations, and the provision of public services?)</span>
	        </li>
	        <li>
	            <span>Impact of AI on Education and Learning (How does AI influence the formation of knowledge, skills, and competencies for future life, work, and society?)</span>
	        </li>
	        <li>
	            <span>Submission guidelines (Should Ideathon encourage, restrict, or prevent the use of AI by participants for creative purposes?)</span>
	        </li>
	    </ol>
	    <p>
	        <span>Please indicate if you agree, disagree, or skip with this idea and share your thoughts below.</span>
	    </p>
</article>
`;
